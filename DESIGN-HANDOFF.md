# 5e057c30-4d6e-47b7-868c-5e19d1be7286 implementation handoff

This archive is the source of truth for turning the design into production code. Start from `climate-intelligence-dashboard.html`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
## Source map
- Primary entry: `climate-intelligence-dashboard.html`
...
- A single self-contained `climate-intelligence-dashboard.html` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `climate-intelligence-dashboard.html` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
## Entry points
- `climate-intelligence-dashboard.html`
...
1. Inspect `climate-intelligence-dashboard.html` and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
